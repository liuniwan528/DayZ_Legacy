...
_sm setParticleParams [["\DZ\data\data\ParticleEffects\Universal\Universal", 16, 12, 8,0],
		"", "Billboard", 1, 3, [0, 0, 0],
...
_sp setParticleParams [["\DZ\data\data\ParticleEffects\Universal\Universal", 16, 13, 2,0],
