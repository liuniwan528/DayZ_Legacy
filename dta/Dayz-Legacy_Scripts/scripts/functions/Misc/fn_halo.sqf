scriptName "modules_f\Functions\objects\fn_HALO.sqf";
/*
	File: fn_HALO.sqf
...
if (typename _this == typename objnull) then {
	...
	if (_unit == player) then {
		...
		_parray = [
		/* 00 */		["\DZ\data\data\ParticleEffects\Universal\Universal", 16, 12, 13, 0],
		/* 01 */		"",
		/* 02 */		"Billboard",
		/* 03 */		1,
		/* 04 */		3,
		...
		bis_fnc_halo_action = _unit addaction [localize "STR_HALO_OPEN_CHUTE","DZ\functions\misc\fn_HALO.sqf",[],1,true,true,"Eject"];
