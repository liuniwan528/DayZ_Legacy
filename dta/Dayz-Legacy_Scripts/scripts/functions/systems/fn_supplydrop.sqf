...
FNC_SMOKE = {
  [_this select 0,[0.45,0.67,0.5,0]] spawn {
  	...
  	_source setParticleParams [["\DZ\Data_h\ParticleEffects\Universal\Universal", 16, 7, 48], "", "Billboard", 1, 20, [0, 0, 0],
  	...
  	_source2 setParticleParams [["\DZ\Data_h\ParticleEffects\Universal\Universal", 16, 12, 8, 0], "", "Billboard", 1, 20, [0, 0, 0],
...
//textLogFormat["SUPPLYDROP_ Pos cargoRelPos _cargoPos %1",[_pos,_cargoRelPos, _cargoPos]];
...
//textLogFormat ["DROP_ BeforeWhile cratePos %1 %2 parapos %3 %4",_crate, position _crate, _para, position _para];
