...
_smoke setParticleParams [["\dz\data\data\ParticleEffects\Universal\Universal",16,7,48],
...
/*_fire setParticleParams [["\dz\data\data\ParticleEffects\Universal\Universal",16,2,32], "", "Billboard", 1, 1, [0, 1, 0], [0, 0, 0], 1, 1.275, 1, 0, [10,15],
          [[1,1,1,-1],[1,1,1,0]], [0.5], 0.01, 0.01, "", "", _v,360]; */
_fire setParticleParams [["\dz\data\data\ParticleEffects\Universal\Universal",16,2,80],
...
_shards setParticleParams [["\dz\data\data\ParticleEffects\Shard\shard",1,0,1], "", "SpaceObject", 1, 60, [0, 0, 0], [0, 0, 0], 0, 1.275, 1, 0, [1,1],
                       [[1,1,1,1]], [0.5], 0, 0, "", "", _v];
...
_dirt setParticleParams [["\dz\data\data\ParticleEffects\Universal\Universal",16,12,9,0], "", "Billboard", 1, 5, [0, 0, 0], [0, 0, 5], 0, 5, 1, 0, [10,20],
