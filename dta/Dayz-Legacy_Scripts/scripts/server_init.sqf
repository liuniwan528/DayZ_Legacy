...
//events
event_saySound =		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_saySound.sqf";
event_weaponFired =		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_weaponFired.sqf";
event_craftMessage = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_craftMessage.sqf";
event_modifier = 		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_modifier.sqf";
event_assessDamage = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_assessDamage.sqf";
event_transferModifiers = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_transferModifiers.sqf";
event_igniteObject = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_igniteObject2.sqf";
event_clearModifiers = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_clearModifiers.sqf";
event_playerKilled = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_playerKilled.sqf";
event_hitZombie =		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_hitZombie.sqf";
event_bloodTransfusion = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_bloodTransfusion.sqf";
event_killedWildAnimal = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_killedWildAnimal.sqf";
event_killedZombie = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_killedZombie.sqf";
event_gasLight = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_gasLight.sqf";
event_openCan = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\events\event_openCan.sqf";

//players
//player_checkStealth = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_checkStealth.sqf";
player_colorpelt = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_colorpelt.sqf";
player_barrelcheck = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_barrelcheck.sqf";
player_craftfertilizer = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_craftfertilizer.sqf";
player_bleachitem = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_bleachitem.sqf";
player_tanpelt = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_tanpelt.sqf";
player_coloritem = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_coloritem.sqf";
player_combineQuantity = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_combineQuantity.sqf";
player_splitQuantity = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_splitQuantity.sqf";
player_useItem =		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_useItem.sqf";
player_useItemEnd =		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_useItemEnd.sqf";
player_fillBottle =		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_fillBottle.sqf";
player_stripMagazine = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_stripMagazine.sqf";
player_loadMagazine = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_loadMagazine.sqf";
player_addInventory = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_addInventory.sqf";
player_actionOnTarget = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_actionOnTarget.sqf";
player_actionOnSelf = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_actionOnSelf.sqf";
player_actionOnItem = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_actionOnItem.sqf";
player_combineMoney = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_combineMoney.sqf";
player_applyBandage = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_applyBandage.sqf";
player_chamberRound = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_chamberRound.sqf";
player_loadWeapon = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_loadWeapon.sqf";
player_pickBerry =		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_pickBerry.sqf";
player_moveToInventory =	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_moveToInventory.sqf";
player_applyDefibrillator = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_applyDefibrillator.sqf";
player_mendItem = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_mendItem.sqf";
player_igniteFireplace = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_igniteFireplace.sqf";
player_RabbitSnareTrap = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_RabbitSnareTrap.sqf";
player_bearTrap		 = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_bearTrap.sqf";
player_landMine		 = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_landMine.sqf";
player_plantStages = 		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_plantStages.sqf";
player_harvestPlant	=		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_harvestPlant.sqf";
player_digGreenhouse=		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_digGreenhouse.sqf";
player_dryClothes = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_dryClothes.sqf";
player_gutDeadBodyCheck = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_gutDeadBodyCheck.sqf";
player_gutDeadBodyStart = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_gutDeadBodyStart.sqf";
player_gutDeadBodyEnd = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_gutDeadBodyEnd.sqf";
player_gutDeadBodyCancel = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_gutDeadBodyCancel.sqf";
player_useDuctTapeOnItem = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_useDuctTapeOnItem.sqf";
player_DigTile = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_DigTile.sqf";
player_liquidSource = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_liquidSource.sqf";
player_liquidConsumed = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_liquidConsumed.sqf";
player_tanPeltInAction = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_tanPeltInAction.sqf";
player_sewLeatherClothing = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\players\player_sewLeatherClothing.sqf"; 

//cooking
cooking_cookingProcess = compile preprocessFileLineNumbers 	"\bin\scripts\server\scripts\cooking\cooking_cookingProcess.sqf";
cooking_processFood = compile preprocessFileLineNumbers 	"\bin\scripts\server\scripts\cooking\cooking_processFood.sqf";
cooking_manageActions = compile preprocessFileLineNumbers	"\bin\scripts\server\scripts\cooking\cooking_manageActions.sqf";
//fireplace
fireplace_manageFire = compile preprocessFileLineNumbers 	"\bin\scripts\server\scripts\cooking\fireplace_manageFire.sqf";
fireplace_manageFuel = compile preprocessFileLineNumbers 	"\bin\scripts\server\scripts\cooking\fireplace_manageFuel.sqf";
fireplace_manageState = compile preprocessFileLineNumbers 	"\bin\scripts\server\scripts\cooking\fireplace_manageState.sqf";
fireplace_manageActions = compile preprocessFileLineNumbers	"\bin\scripts\server\scripts\cooking\fireplace_manageActions.sqf";
//gascooker
gascooker_manageActions = compile preprocessFileLineNumbers	"\bin\scripts\server\scripts\cooking\gascooker_manageActions.sqf";
gascooker_manageFire = compile preprocessFileLineNumbers	"\bin\scripts\server\scripts\cooking\gascooker_manageFire.sqf";

//weapons
weapon_swapHandguard = compile preprocessFileLineNumbers "\bin\scripts\server\scripts\weapons\weapon_swapHandguard.sqf";

//server
building_spawnLoot =	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\server\building_spawnLoot.sqf";
init_spawnLoot = 		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\init\spawnLoot.sqf";
init_spawnZombies = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\init\spawnZombies.sqf";
init_spawnWildAnimals = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\init\spawnWildAnimals.sqf";
init_spawnServerEvent = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\init\spawnServerEvent.sqf";
player_queued = 		compile preprocessFileLineNumbers "\bin\scripts\modulesDayZ\scripts\player_queued.sqf";

//functions
fnc_generateTooltip = 	compile preprocessFileLineNumbers "\bin\scripts\modulesDayZ\scripts\fn_generateTooltip.sqf";
fnc_inString = 			compile preprocessFileLineNumbers "\bin\scripts\server\scripts\functions\fn_inString.sqf";
fnc_inAngleSector =  	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\functions\fn_inAngleSector.sqf";
fnc_isMaxQuantity = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\functions\isMaxQuantity.sqf";
BIS_fnc_findSafePos =	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\functions\fn_findSafePos.sqf";
fnc_generateQuantity =	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\functions\fn_generateQuantity.sqf";
dayz_losCheck =			compile preprocessFileLineNumbers "\bin\scripts\server\scripts\functions\dayz_losCheck.sqf";
dayz_losChance = 		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\functions\dayz_losChance.sqf";
dayz_bulletHit = 		compile preprocessFileLineNumbers "\bin\scripts\modulesDayZ\scripts\dayz_bulletHit.sqf";
fnc_playerMessage =		compile preprocessFileLineNumbers "\bin\scripts\modulesDayZ\scripts\fn_playerMessage.sqf";
runZombieBrain =		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\functions\runZombieBrain.sqf";
tick_modifiers =		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\functions\tick_modifiers.sqf";
tick_states =			compile preprocessFileLineNumbers "\bin\scripts\server\scripts\functions\tick_states.sqf";
tick_environment = 		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\functions\tick_environment.sqf";
randomValue =			compile preprocessFileLineNumbers "\bin\scripts\modulesDayZ\scripts\randomValue.sqf";
dbLoadPlayer = 			compile preprocessFileLineNumbers "\bin\scripts\server\scripts\functions\dbLoadPlayer.sqf";
world_surfaceNoise = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\functions\fn_surfaceNoise.sqf";
farmingFunctions =		[] execVM "\bin\scripts\server\scripts\functions\farming.sqf";
cutoutSeedsFunctions = 	[] execVM "\bin\scripts\server\scripts\functions\cutoutSeedsFunctions.sqf";

//initialize
zombie_initialize = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\init\zombie_initialize.sqf";
player_initialize = 	compile preprocessFileLineNumbers "\bin\scripts\server\scripts\init\player_initialize.sqf";
init_battery = 		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\init\battery_initialize.sqf";
init_cooker = 		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\init\cooker_initialize.sqf";
init_fireplace = 		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\init\fireplace_initialize.sqf";
init_kindling = 		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\init\kindling_initialize.sqf";
init_flare = 		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\init\flare_initialize.sqf";
init_torch = 		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\init\torch_initialize.sqf";
init_wreck = 		compile preprocessFileLineNumbers "\bin\scripts\server\scripts\init\wreck_initialize.sqf";
init_lamp =
{
	if (isServer) then
	{
...
init_newBody =
{
	...
	[_id] spawnForClient compile "player execFSM '\bin\scripts\fsm\brain_player_client.fsm'";
	...
	[_id,_uid,_agent] spawn ext_admin_check;
...
player_coverHead = {
	...
	if (_hide) then
	{
		...
		{
			_agent spawnForPlayer compile "setAperture 10000;1 fadeSound 0;1 fadeSpeech 0;";
		}
		else
		{
...
/*
player_suicide = {
	_fsm = [_person,_this] execFSM "\bin\scripts\fsm\player_suicide.fsm";
...
player_transferWater = {
	...
	{
		[_owner,format["There is already something in %1",_name2],""] call fnc_playerMessage;
	};
...
fnc_processItemWetness = {
	...
	*/
	...
	if (isNull _item)exitWith{
		_playerWet = ((_playerWet + (_delta * 200000 * _scale)) min 1) max 0;
	};
...
// 057		_person moveItemFromHandsToInventory _item;
		...
		if (!isNull _oldItem) then
		{
			...
			if ((!isNull _item) && !_itemWasDeleted) then {
...
fn_weaponfired ={
	/*
		Created by Linker_Split and RaVen
	*/
	private["_unit","_weapon","_inHands","_dam","_rnd"];
	_unit = _this select 0;
	_weapon = _this select 1;
	_inHands = itemInHands _unit;
	_dam = damage _inHands;
	_rnd = (random 10);
	_newdam = (sqrt(sqrt(_dam) + 0.0015)^4);	//About 833 rounds before runining the weapon
	_inHands setDamage _newdam;
	if ((_dam >= 0.70) && (_dam < 0.85) && (_rnd < 10)) then
	{
		[_unit,format["Damn! my %1 is jammed!",_weapon],"colorImportant"] call fnc_playerMessage;
		_unit playAction "ReloadM4";
	};
	if ((_dam >= 0.85) && (_rnd < 25)) then
	{
		[_unit,format["Damn! my %1 is jammed!",_weapon],"colorImportant"] call fnc_playerMessage;
		_unit playAction "ReloadM4";
	};
...
//058			dbStats ["calories",_person,_energyGathered];
...
//058			dbStats ["water",_person,_waterGathered];
...
fnc_changeFoodStage =
{
	...
	if (!(isNil "_food_stage") and 
		!([_food, _food_stage_name_new] call _can_change_to_stage) ) exitWith {};
	...
	//TRANSFER MODIFIERS
	[_food, _food_stage_name] call _transfer_food_modifiers;
...
diag_log "--- CALL: dz\server\scripts\init. END";