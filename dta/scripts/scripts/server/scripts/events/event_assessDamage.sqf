//057 ProfileStart "event_assessDamage.sqf";
...
//057			admin_log format ['%1(uid=%2) has fallen into unconsciousness. HARD HIT Total S::%3', name _agent, getPlayerUID _agent, _totalShock];
		};
	};
	case "hands":
	{
...
//057ProfileStop "event_assessDamage.sqf";
