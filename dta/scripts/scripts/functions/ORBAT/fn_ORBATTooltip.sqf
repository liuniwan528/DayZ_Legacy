/*
	...
	BOOL
*/
disablesierialization;
private ["_classParams","_tooltip","_tooltipText","_tooltipPicture","_mousepos","_configname","_subClassesCount","_text","_texture","_size","_color","_textureSize","_infoText","_infoPosX","_infoPosY","_infoPosW","_infoPosH"];
