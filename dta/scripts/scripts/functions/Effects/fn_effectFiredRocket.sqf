...
_p = getpos _sh;
	...
	drop [["\DZ\data\data\ParticleEffects\Universal\Universal",16,2,32], "", "Billboard", 1,(0.1 + random 0.1), 
	[0, -1.3,0], 
...
do
	{
	drop [["\DZ\data\data\ParticleEffects\Universal\Universal", 16, 7, 48], "", "Billboard", 1, 1.5, [0, - 1.3, 0],
...
if ((abs(_p select 2) < 2) and !(surfaceiswater _p)) then 			{
			...
			while {_i<_no} do 
				{
				drop [["\DZ\data\data\ParticleEffects\Universal\Universal.p3d", 16, 12, 13, 0], "", "Billboard", 1, 7, 
