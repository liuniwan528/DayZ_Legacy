...
if (_num>0) then
{
...

	{
		[_x] spawn
		{
			...
			_source2 setParticleParams [["\DZ\data\data\ParticleEffects\Universal\Universal", 16, 7, 48, 1], "", "Billboard", 1, 10, [0, 0, 0],
			...
			_source3 setParticleParams [["\DZ\data\data\ParticleEffects\Universal\Universal", 16, 12, 7, 0], "", "Billboard", 1, 5, [0, 0, 0],
