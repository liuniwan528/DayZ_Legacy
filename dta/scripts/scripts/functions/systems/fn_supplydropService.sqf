//scriptName "Functions\systems\fn_supplydropService.sqf";
/*
...
[_caller, _veh, _override] onMapSingleClick 
  {
    if (_alt) then 
      {
        [_this select 0, _this select 1, _pos, _this select 2] execFSM "DZ\ModulesCore\modules\functions\systems\fn_supplydropService.fsm";
        hint "";
      }
  };
