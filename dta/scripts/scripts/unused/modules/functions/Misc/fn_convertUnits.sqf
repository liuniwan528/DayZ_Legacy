...
if (_destMode != 0) then 
{
	...
	switch (_destMode) do 
	{
		case 1: 
		{
			switch (_destUnit) do 
			{
				case 0: {_units = localize "STR_DZunitFull_m";};
				case 1: {_units = localize "STR_DZunitFull_km";};
				case 2: {_units = localize "STR_DZunitFull_ms";};
				case 3: {_units = localize "STR_DZunitFull_kmh";};
				case 4: {_units = localize "STR_DZunitFull_ft";};
				case 5: {_units = localize "STR_DZunitFull_mi";};
				case 6: {_units = localize "STR_DZunitFull_fts";};
				case 7: {_units = localize "STR_DZunitFull_mph";};
				case 8: {_units = localize "STR_DZunitFull_nm";};
				case 9: {_units = localize "STR_DZunitFull_kts";};
				case 10: {_units = localize "STR_DZunitFull_kg";};
				case 11: {_units = localize "STR_DZunitFull_lb";};
			};
		};
		...
		case 2: 
		{
			switch (_destUnit) do 
			{
				case 0: {_units = localize "STR_DZunitShort_m";};
				case 1: {_units = localize "STR_DZunitShort_km";};
				case 2: {_units = localize "STR_DZunitShort_ms";};
				case 3: {_units = localize "STR_DZunitShort_kmh";};
				case 4: {_units = localize "STR_DZunitShort_ft";};
				case 5: {_units = localize "STR_DZunitShort_mi";};
				case 6: {_units = localize "STR_DZunitShort_fts";};
				case 7: {_units = localize "STR_DZunitShort_mph";};
				case 8: {_units = localize "STR_DZunitShort_nm";};
				case 9: {_units = localize "STR_DZunitShort_kts";};
				case 10: {_units = localize "STR_DZunitShort_kg";};
				case 11: {_units = localize "STR_DZunitShort_lb";};
			};
		};
	};
