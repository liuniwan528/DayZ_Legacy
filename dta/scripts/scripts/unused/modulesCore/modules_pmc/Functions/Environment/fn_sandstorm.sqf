...
_ps setParticleParams [["\DZ\Data_h\ParticleEffects\Universal\universal.p3d", 16, 12, 8, 0], "", "Billboard", 1, _duration, _relPos, _velocity, 1, 1.275, 1, 0, [5], [_color + [0], _color + [_alpha], _color + [0]], [1000], 1, 0, "", "", _obj];
...
_result = if (_newspapers) then {
	_newsParams = [["\dz\Missions_PMC\gnews1.p3d", 1, 0, 1], "", "SpaceObject", 1, 5, [0, 0, 1], _velocity, 1, 1.25, 1, 0.2, [0,1,1,1,0], [[1,1,1,1]], [0.7], 1, 0, "", "", _obj];
	...
	_newsParams set [0,["\dz\Missions_PMC\gnews2.p3d", 1, 0, 1]];
	...
	_newsParams set [0,["\dz\Missions_PMC\gnews3.p3d", 1, 0, 1]];
