...
_this spawn {
	...
	IND_1 ctrlsettext "dz\missions_pmc\data\ui_dir_1_ca.paa";
	IND_2 ctrlsettext "dz\missions_pmc\data\ui_dir_2_ca.paa";
	IND_3 ctrlsettext "dz\missions_pmc\data\ui_dir_3_ca.paa";
	IND_4 ctrlsettext "dz\missions_pmc\data\ui_dir_4_ca.paa";
