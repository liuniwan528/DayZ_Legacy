...
while {!(isnull _v)} do
	...
	*/
	...
	if (_intensity>0.3) then
		...
		_trail1 setParticleParams [["\dz\data\data\ParticleEffects\Universal\Universal.p3d", 16, 13, 3, 0],
		...
		_trail2 setParticleParams [["\dz\data\data\ParticleEffects\Universal\Universal.p3d", 16, 13, 3, 0],
		"", "Billboard", 1, 0.6*_intensity, 
		[0,0,0], velocity _v, 
		0, 1, 0.79, 0.18, 
	...
	if ((_intensity>0.4)) then
	{
		...
		if (_int2>0) then
			...
			_x setParticleParams [["\dz\data\data\ParticleEffects\Universal\Universal.p3d", 16, 12, 13, 0],
