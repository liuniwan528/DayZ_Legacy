...
if (_life==0) exitwith {};
drop [["\dz\data\data\ParticleEffects\Universal\Universal",16,12,8],
...
if ((abs(_p select 2) < _int) and !(surfaceiswater _p)) then
			...
			drop [["\dz\data\data\ParticleEffects\Universal\Universal.p3d", 16, 12, 13, 0], "", "Billboard", 1, 0.9 + random 0.3,
