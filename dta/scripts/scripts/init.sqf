...
if (isServer) then
{	
	"GlobalMessage" addPublicVariableEventHandler
	{
		_array = _this select 1;
		_name = _array select 0;
		_message = _array select 1;
		diag_log format["MESSAGE: %1: %2", _name, _message];
		{
			diag_log format["MESSAGE: sent to %1", name _x];
			[owner _x, _name, _message] spawnForClient {statusChat [format["%1: %2", _this select 1, _this select 2],"colorAction"]};
		} foreach players;
	};
};
...
//Replace functions
call compile preprocessFileLineNumbers "\bin\scripts\DayzFunctions.sqf";
MainMenuOpen = false;

if (isServer) then
{
	call compile preprocessFileLineNumbers "\bin\scripts\server_init.sqf";
};
...
fnc_isItemDuctTapeCompatible = 	compile preprocessFileLineNumbers "\bin\scripts\modulesDayZ\scripts\fnc_isItemDuctTapeCompatible.sqf";

//ui
ui_characterScreen =	compile preprocessFileLineNumbers "\bin\scripts\modulesDayZ\scripts\ui_characterScreen.sqf";
ui_defaultCharacterScreen =	compile preprocessFileLineNumbers "\bin\scripts\modulesDayZ\scripts\ui_defaultCharacterScreen.sqf";
ui_newScene =		compile preprocessFileLineNumbers "\bin\scripts\modulesDayZ\scripts\ui_newScene.sqf";

//melee
melee_startAttack = 	compile preprocessFileLineNumbers "\bin\scripts\modulesDayZ\scripts\melee_startAttack.sqf";
melee_finishAttack = 	compile preprocessFileLineNumbers "\bin\scripts\modulesDayZ\scripts\melee_finishAttack.sqf";
event_playerBleed = 	compile preprocessFileLineNumbers "\bin\scripts\modulesDayZ\scripts\event_playerBleed.sqf";

//init
init_fireplace = compile preprocessFileLineNumbers			"\bin\scripts\modulesDayZ\scripts\init\fireplace_initialize.sqf";
init_cooking_food = compile preprocessFileLineNumbers		"\bin\scripts\modulesDayZ\scripts\init\cooking_food_initialize.sqf";
init_gascooker = compile preprocessFileLineNumbers			"\bin\scripts\modulesDayZ\scripts\init\gascooker_initialize.sqf";
init_gascanister = compile preprocessFileLineNumbers		"\bin\scripts\modulesDayZ\scripts\init\gascanister_initialize.sqf";
init_cooking_equipment = compile preprocessFileLineNumbers			"\bin\scripts\modulesDayZ\scripts\init\cooking_equipment_initialize.sqf";
//action conditions
cooking_action_condition = compile preprocessFileLineNumbers 	"\bin\scripts\modulesDayZ\scripts\cooking\cooking_action_condition.sqf";
fireplace_action_condition = compile preprocessFileLineNumbers 	"\bin\scripts\modulesDayZ\scripts\cooking\fireplace_action_condition.sqf";
fireplace_state_condition = compile preprocessFileLineNumbers 	"\bin\scripts\modulesDayZ\scripts\cooking\fireplace_state_condition.sqf";
barrel_action_condition = compile preprocessFileLineNumbers 	"\bin\scripts\modulesDayZ\scripts\cooking\barrel_action_condition.sqf";

//event
event_explosives = compile preprocessFileLineNumbers 	"\bin\scripts\modulesDayZ\scripts\event\event_explosives.sqf";
event_ammo = compile preprocessFileLineNumbers 			"\bin\scripts\modulesDayZ\scripts\event\event_ammo.sqf";
